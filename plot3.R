...
plot(myData$Datetime, myData$Sub_metering_1, col='blue', type="l", ylab="Energy Submetering", xlab="")
lines(myData$Datetime, myData$Sub_metering_2, type="l", col="red")
lines(myData$Datetime, myData$Sub_metering_3, type="l", col="green")
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1, lwd=2.5, col=c("blue", "red", "green"), bg = "transparent", box.col = "transparent")
dev.off()
